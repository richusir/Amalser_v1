...
const array = ['Alvin','DJ','sir','bike','bts','Richu','alone','angene','beggin,hiba','bestie','bgm10','bgm11','bgm12','bgm13','bgm14','bgm15','bgm2','bgm4','bgm5','bgm6','bgm7','bgm8','bgm9','blackpink','breakup','chiri','christiano','cr','CR7','cr7','cute','da','drop','eda','eduthu','end','exam','fan','fight','friend','football','ghost','goodnight','hacker','help','hiba,nwantiti','i love u','indaki','joli','kalikka','king','kozhi','leo','list','mass','maths','mayavi','messi','Mishal','mridhu','Mridhula','neymar','peace','pever','poda','power','premam','richu','romance','ronaldo','room','sad','scene','sed','sorry','tentacion','thep','tnx','va','vannu','vijay','whatsapp','xxx','yadu','ho','she','ra','mu','hot','ta','Cr7','uyir','power','va','wow','se','no','nanba','sebin','messi','maman','pha','oi','cha','muth','kiss','dey','ga','player','king','kayari','aliya','nari','omban','Hii','Da','sad','nee','myre','mood','bg','chunk','ser','kundan','sir','My','myr','umbi','bot','poda','git','alive','owner','neymar','list','oii','on','one','vanne','vannu','set','Fuck','love','broke','ohoo','Bye','pne','left','don','onn','stop','setta','entry','muth','Hi','chaya']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['love','list','machu','menu','mute','onn','oo','so','unmute','wait','adi','army','bye','chaya','edit','ip','kayari','mari','money','monu','nallath','night','nyt','on','patti','po','poth','sir','Amal','Hii','ee','Da','food','Hlo','para','set','sed','jada','amal','Hi','sad','don','Loki','bye']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
